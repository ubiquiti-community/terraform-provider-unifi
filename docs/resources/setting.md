...
- `etherlighting` (Attributes) Etherlighting settings. (see [below for nested schema](#nestedatt--etherlighting))
...
<a id="nestedatt--etherlighting"></a>
### Nested Schema for `etherlighting`

Optional:

- `network_overrides` (Attributes List) Network color overrides. (see [below for nested schema](#nestedatt--etherlighting--network_overrides))
- `speed_overrides` (Attributes List) Speed color overrides. (see [below for nested schema](#nestedatt--etherlighting--speed_overrides))

<a id="nestedatt--etherlighting--network_overrides"></a>
### Nested Schema for `etherlighting.network_overrides`

Required:

- `color` (String) Hex color code without the `#` prefix.
- `network` (String) Network ID.


<a id="nestedatt--etherlighting--speed_overrides"></a>
### Nested Schema for `etherlighting.speed_overrides`

Required:

- `color` (String) Hex color code without the `#` prefix.
- `speed` (String) Speed name (e.g., `FE`, `GbE`, `2.5GbE`, `5GbE`, `10GbE`, `25GbE`, `40GbE`, `100GbE`).

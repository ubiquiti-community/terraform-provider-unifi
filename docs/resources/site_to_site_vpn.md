...
- `esp_lifetime` (String) ESP (phase 2) security-association lifetime, as a Go duration string (e.g. `1h`, `3600s`).
...
- `ike_lifetime` (String) IKE (phase 1) security-association lifetime, as a Go duration string (e.g. `8h`, `28800s`).

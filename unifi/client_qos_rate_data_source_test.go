...
func TestNewClientQosRateDataSource(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := NewClientQosRateDataSource(); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("NewClientQosRateDataSource() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func Test_clientQosRateDataSource_Read(t *testing.T) {
	type args struct {
		ctx  context.Context

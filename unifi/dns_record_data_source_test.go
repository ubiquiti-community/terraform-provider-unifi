...
func TestNewDNSRecordDataSource(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := NewDNSRecordDataSource(); !reflect.DeepEqual(got, tt.want) {
				t.Errorf("NewDNSRecordDataSource() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func Test_dnsRecordDataSource_Read(t *testing.T) {
	type args struct {
		ctx  context.Context

...
func Test_firewallGroupResource_Create(t *testing.T) {
	type args struct {
		ctx  context.Context
	...
	tests := []struct {
		...
		{
			name: "requires initialized terraform plan/state",
			r:    &firewallGroupResource{},
		},
	}
	for _, tt := range tests {
...
func Test_firewallGroupResource_Read(t *testing.T) {
	type args struct {
		ctx  context.Context
...
func Test_firewallGroupResource_Update(t *testing.T) {
	type args struct {
		ctx  context.Context
...
func Test_firewallGroupResource_Delete(t *testing.T) {
	type args struct {
		ctx  context.Context
...
func Test_firewallGroupResource_ImportState(t *testing.T) {
	type args struct {
		ctx  context.Context
...
func Test_firewallGroupResource_List(t *testing.T) {
	type args struct {
		ctx    context.Context
	...
	tests := []struct {
		...
		{
			name: "requires configured client",
			r:    &firewallGroupResource{},
		},
	}
	for _, tt := range tests {
